export default {
    ...
    "BLOCK_1546412605792": "send upload mode message [string_1] ",
    "BLOCK_1546413597853": "send upload mode message [string_1] with value [VALUE]",
    "BLOCK_1546413700881": "when receiving upload mode message [string_1] ",
